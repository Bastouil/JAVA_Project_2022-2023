...
public class Land extends JButton
{
	...
	// Constructeurs ******************************************************************************
	// les paramètres du constructeur sont les coordonnées du bouton au sein de la carte
	Land(int x, int y)
	{
		super();
		...
		{  
			...
			{   
				...
				Land x = (Land) evt.getSource();
				// recupere l'info
				System.out.println("Nom :" + x.getName());
				EditLandInterface editer = new EditLandInterface(x);
			}
		});
	}
	...
	{
		cInt = Integer.parseInt(this.getText());
		this.setBackground(getColor(cInt));
	}
