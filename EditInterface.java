...
public class EditInterface extends JDialog {
	...
	// listeners de fermeture de fenêtre
	...
	// listener pour le chargement d'un fichier
	...
	// listeners pour l'enregistrement d'un fichier
	...
	// Constructeurs ***************************************************************
	/*
	 * Constructeur de l'interface d'édition servant à la modification de la hauteur
	 * d'une case.
	 */
	...
	/*
	 * Constructeur de l'interface d'édition servant à l'enregistrement et au
	...
	// Methodes ********************************************************************
	/*
	 * Ferme proprement la fenêtre de dialogue
	 */
	...
	/*
	 * Récupère l'entier contenu dans la zone de texte et le force à être entre 0 et
	 * 30
	 */
	private int getInt() {
